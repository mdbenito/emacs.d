...
(custom-set-variables
 ...
 '(ido-cr+-auto-update-blacklist (quote notify))
 ...
 '(package-selected-packages
   (quote
    (web-mode solaire-mode page-break-lines dsvn yaml-mode rainbow-delimiters dash-at-point expand-region spinner flx flx-ido flx-isearch ein matlab-mode easy-hugo clojure-mode company-rtags flycheck-rtags company-irony company-c-headers anaconda-mode docker-tramp delight company-anaconda bash-completion powerline 4clojure magit-popup neotree popup popup-complete popwin cider ac-cider company company-shell conda ido-at-point magit-filenotify magit-find-file magit-gh-pulls rotate cython-mode multiple-cursors nlinum cmake-ide cmake-mode dockerfile-mode all-the-icons doom-themes tabbar markdown-mode markdown-preview-eww markdown-toc sr-speedbar smooth-scrolling tagedit smex paredit modern-cpp-font-lock ido-ubiquitous flycheck-irony flycheck-cython flycheck-clangcheck exec-path-from-shell darcula-theme company-statistics company-irony-c-headers clojure-mode-extra-font-locking)))
