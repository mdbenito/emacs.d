...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode web-mode web-mode-edit-element rainbow-delimiters solaire-mode dash-at-point expand-region spinner flx flx-ido flx-isearch ein matlab-mode easy-hugo clojure-mode company-rtags flycheck flycheck-rtags company-irony company-c-headers rtags anaconda-mode docker-tramp realgud delight company-anaconda bash-completion powerline 4clojure magit magit-popup neotree page-break-lines popup projectile popup-complete popwin cider ac-cider company company-shell conda ido-at-point ido-completing-read+ magit-filenotify magit-find-file magit-gh-pulls magithub rotate cython-mode multiple-cursors paradox nlinum cmake-ide cmake-mode dockerfile-mode all-the-icons doom-themes tabbar markdown-mode markdown-preview-eww markdown-toc sr-speedbar smooth-scrolling tagedit smex paredit modern-cpp-font-lock ido-ubiquitous flycheck-irony flycheck-cython flycheck-clojure flycheck-clangcheck exec-path-from-shell darcula-theme company-statistics company-irony-c-headers clojure-mode-extra-font-locking mode-icons)))
 ...
 '(safe-local-variable-values
   (quote
    ((c-default-style . "linux")
     ...
     (pythonic-environment . "~/miniconda3/envs/py3"))))
